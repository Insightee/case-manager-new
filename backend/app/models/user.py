...
class User(Base):
    ...
    external_employee_id: Mapped[Optional[str]] = mapped_column(String(64), unique=True, nullable=True, index=True)
    ...
    school_address_line1: Mapped[Optional[str]] = mapped_column(String(255))
    school_address_line2: Mapped[Optional[str]] = mapped_column(String(255))
    school_city: Mapped[Optional[str]] = mapped_column(String(128))
    school_state: Mapped[Optional[str]] = mapped_column(String(128))
    school_pincode: Mapped[Optional[str]] = mapped_column(String(16))
    school_landmark: Mapped[Optional[str]] = mapped_column(String(255))
    school_latitude: Mapped[Optional[float]] = mapped_column(Float)
    school_longitude: Mapped[Optional[float]] = mapped_column(Float)
    preferred_visit_address_type: Mapped[Optional[str]] = mapped_column(String(16), default="home")
    ...
    ui_preferences: Mapped[Optional[dict]] = mapped_column(JSON, default=dict)
